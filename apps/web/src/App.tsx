...
//   /notes        → all annotations + notes    (auth)
//   /ai           → library-wide AI chat       (auth)
//   /stats        → reading statistics         (auth)
//   /settings     → account + AI providers     (auth)
export function App() {
  return (
    <AuthProvider>
      <ToastProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/ai"       element={<AuthGuard><AIChatPage /></AuthGuard>} />
